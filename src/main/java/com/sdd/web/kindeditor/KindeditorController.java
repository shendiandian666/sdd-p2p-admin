package com.sdd.web.kindeditor;
...
public class KindeditorController {
	...
	public void file_upload(MultipartHttpServletRequest request, HttpServletResponse response) throws Exception {

		ServletContext application = request.getSession().getServletContext();
		String savePath = localLocation;//"D:/p2p/upload/";//application.getRealPath("/") + "attached/";
		// 文件保存目录URL
		String saveUrl = remoteLocation;//"http://localhost:8888/upload/";//request.getScheme()+"://" + request.getServerName() + "/upload/";
		// 定义允许上传的文件扩展名
	...
	public void file_manager(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String rootPath = localLocation;//"D:/p2p/upload/";//application.getRealPath("/") + "attached/";
		// 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
		String rootUrl = remoteLocation;//"http://localhost:8888/upload/";//request.getServerName() + "/upload/";
		// 图片扩展名
